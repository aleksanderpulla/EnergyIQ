...
import { getConsumption, queryYearlyConsumption } from "@/lib/database/data";
            ...
            <TabsContent value="overview" className="space-y-4">
              <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4 py-4">
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="text-2xl font-bold">{frequency} Hz</div>
                  </CardContent>
                </Card>
              </div>
              <Card className="col-span-12">
                <CardHeader>
                  <CardTitle>Yearly Usage (energy)</CardTitle>
                </CardHeader>
                <CardContent>
                  <YearlyUsage yearlyConsumption={yearlyConsumption} />
                </CardContent>
              </Card>
            </TabsContent>
          </Tabs>
